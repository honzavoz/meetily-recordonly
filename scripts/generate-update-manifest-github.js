...
console.log(`GitHub Repository: honzavoz/meetily-recordonly`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/honzavoz/meetily-recordonly/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/honzavoz/meetily-recordonly/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/honzavoz/meetily-recordonly/releases/latest/download/latest.json`);
