...
if (-not (Test-Path "whisper-server-package\whisper-server.exe")) {
    ...
    try {
        ...
        $apiUrl = "https://api.github.com/repos/Zackriya-Solutions/meetily/releases/latest"
        ...
        $downloadUrl = "https://github.com/Zackriya-Solutions/meetily/releases/download/$tagName/whisper-server.exe"
        ...
        try {
            $allReleasesUrl = "https://api.github.com/repos/Zackriya-Solutions/meetily/releases"
            $headers = @{"User-Agent" = "PowerShell-Script"}
            ...
            if ($releases.Count -gt 0) {
                ...
                $altDownloadUrl = "https://github.com/Zackriya-Solutions/meetily/releases/download/$latestTag/whisper-server.exe"
            ...
            Write-Host "https://github.com/Zackriya-Solutions/meetily/releases"
