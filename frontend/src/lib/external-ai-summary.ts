...
function buildFinalReportPrompt(input: BuildPromptPackageInput, sourceText: string): string {
  ...
  const systemPrompt = [
    ...
    "7. Do not mention chunk numbers, prompt parts, segment numbers, or transcript-processing details in the final report.",
    "8. Use natural timestamps or short source references instead of labels like \"Segment 1\" or \"Part 2\".",
    "9. For unknown table values such as owner, due date, or reference, write \"Not specified\" rather than \"None noted in this section.\"",
