...
export function MeetingWorkspaceTabs({ value, onChange }: MeetingWorkspaceTabsProps) {
  return (
    <div
      className="meeting-workspace-switcher absolute inset-x-3 bottom-3 z-30 mx-auto grid max-w-md grid-cols-2 gap-1 rounded-xl border border-gray-200 bg-white/95 p-1.5 shadow-lg backdrop-blur"
      role="group"
