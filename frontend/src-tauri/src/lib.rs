...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::api_remove_meeting_project,
            api::api_list_project_meetings,
            ...
            audio::transcribe_later::assign_transcribe_later_recording_project,
            audio::transcribe_later::remove_transcribe_later_recording_project,
            audio::transcribe_later::transfer_transcribe_later_recording_projects,
